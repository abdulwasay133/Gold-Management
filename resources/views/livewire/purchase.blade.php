    ...
    <div class="col-md-12 mt-2">
      ...
      <div class="card">
        <div class="card-header">
          <div class="card-title">Purchase Table</div>
        </div>
        <div class="card-body">
...
@foreach($purchase->asset as $product)
{{$product->product}}
@endforeach
              </p>
            </td>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <button type="button" wire:click="addpurchase" class="btn btn-primary">Add Purchase</button>
            </div>
          </div>
        </div>
      </div>
